...
- (CGPoint)pointOnCircleWithCenter:(CGPoint)center radius:(double)radius angleInDegrees:(double)angleInDegrees {
    CGFloat x = (CGFloat)(radius * cos(angleInDegrees * M_PI / 180)) + radius;
    CGFloat y = (CGFloat)(radius * sin(angleInDegrees * M_PI / 180)) + radius;
...
- (NSTimeInterval)displayDurationForString:(NSString*)string {
    return MIN((CGFloat)string.length*0.06 + 0.3, 5.0);
}
